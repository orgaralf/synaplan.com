...
--
-- Dumping data for table `BMAILS`
--

LOCK TABLES `BMAILS` WRITE;
/*!40000 ALTER TABLE `BMAILS` DISABLE KEYS */;
INSERT INTO `BMAILS` VALUES
(1,0,'smart@ralfs.ai');
/*!40000 ALTER TABLE `BMAILS` ENABLE KEYS */;
UNLOCK TABLES;
