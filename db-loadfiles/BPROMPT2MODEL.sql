...
--
-- Dumping data for table `BPROMPT2MODEL`
--

LOCK TABLES `BPROMPT2MODEL` WRITE;
/*!40000 ALTER TABLE `BPROMPT2MODEL` DISABLE KEYS */;
/*!40000 ALTER TABLE `BPROMPT2MODEL` ENABLE KEYS */;
UNLOCK TABLES;
